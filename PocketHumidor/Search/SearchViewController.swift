...
class SearchViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate, DZNEmptyDataSetSource, DZNEmptyDataSetDelegate {
    ...
    func title(forEmptyDataSet scrollView: UIScrollView!) -> NSAttributedString! {
        ...
        if noResultsFlag{
            ...
            return NSAttributedString(string: NSLocalizedString("Search Items", comment: ""), attributes: attributes)
        }
        ...
        if noResultsFlag{
            ...
            let attributes =
                [NSAttributedStringKey.font : UIFont.systemFont(ofSize: 18, weight: .light),
                 ...
                 NSAttributedStringKey.backgroundColor : UIColor.clear]
             return NSAttributedString(string: NSLocalizedString("Search items by name, country of origin or size.", comment: ""), attributes: attributes)
        }
